...
export const ViewInvoiceModalAdmin = () => {
  const { invoice } = useSelector((state) => state.AdminInvoicesReducer)
  ...
  const earlyPaymentRequested = invoice?.earlyPaymentRequested
  ...
  return (
    <>
      <div className='modal fade' id='modalViewInvoiceAdmin' tabIndex={-1} aria-labelledby='modalViewItem' aria-hidden='true' aria-modal='true'>
