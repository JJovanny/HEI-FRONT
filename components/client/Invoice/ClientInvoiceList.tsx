...
import { ClientTableInvoice } from './ClientTableInvoice'
import { ClientViewInvoiceModal } from './ClientViewInvoiceModal'

export const ClientInvoiceList = ({ invoices, isLoading }) => {
  return (
    <div className='col-md-8 col-xl-9 h-100' style={{ maxHeight: '900px', overflowY: 'auto' }}>
      <div className='table-responsive'>
        <table className='table table-hover table-nowrap'>
          ...
          <tbody>
            {!isLoading && invoices?.map((invoice) => <ClientTableInvoice invoice={invoice} key={invoice.id} />)}
          </tbody>
        </table>
