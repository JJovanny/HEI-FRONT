...
import { apiPostInviteSupplier } from 'src/client/ClientActions'

export const InviteCompanyByEmail = () => {
  ...
  const handleSendByEmail = async () => {
    await dispatch(apiPostInviteSupplier(email,name))
    setEmail('')
    setName('')
    handleClickClose() 
  }
  ...
  return (
    <>
      <div className='modal fade' id='inviteCompanyModal' data-bs-backdrop='static' data-bs-keyboard='false' tabIndex={-1} aria-labelledby='inviteCompanyModal' aria-hidden='true'>
