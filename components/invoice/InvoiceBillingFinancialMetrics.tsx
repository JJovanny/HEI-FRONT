...
export const InvoiceBillingFinancialMetrics = () => {
    const dispatch = useDispatch()
    const { dataUser: { userType,companyBranchSelected } } = useSelector(state => state.UserReducer)

    const {totalDuethisMonth} = useSelector(state => state.InvoiceReducer)
                ...
                <main id='dashboard' className=''>
                    <div className='card rounded shadow overflow-hidden bg-light'>
                        <div className='card-body p-3 p-lg-3 p-xl-3'>
                            <div className='row g-6 mb-1 justify-content-center d-flex'>
                                        ...
                                        <div className='card-body'>
                                            <div className='row'>
                                                <div className='col text-center'>
                                                    <span className='h6 font-semibold text-muted text-sm text-center d-block mb-2'>{strings('placeholder.totalDuethisMonth')}</span>
